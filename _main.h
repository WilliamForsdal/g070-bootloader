// auto generated by dsg2.py, SRC002-103 commit hash 22601b58a4a8b2f0b4c379cf5e4ac55daa1c7f9c
...
// struct Fuck
struct PACKED JabusRequestFuck
{
    struct JabusHeader header;     // 0
    uint32_t data;                 // 4
}; // size=8, align=0
// struct Fuck
struct PACKED JabusAnswerFuck
{
    struct JabusHeader header;     // 0
    uint32_t data;                 // 4
}; // size=8, align=0
...
// jabus_cmd jabus_cmd Fuck: no bitbanding for this type
...
union PACKED JabusCommands
{
  ...
  struct JabusRequestFuck reqFuck;
  struct JabusAnswerFuck ansFuck;
